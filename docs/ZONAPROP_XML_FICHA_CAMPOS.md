...
| `GENERALES|SUPERFICIE_DEL_TERRENO_(M2)` | Dimensión terreno | m² | `details.superficieTerreno` |
| `GENERALES|SUPERFICIE_DESCUBIERTA_(M2)` | Descubierta | m² | `details.superficieDescubierta` |
| `GENERALES|SUPERFICIE_DE_PLAYA_(M2)` | Playa (lote) | m² | `details.superficiePlaya` |
...
```json
{
  ...
  "caracteristicasRaw": [
    { "nombre": "GENERALES|PILETA", "idValor": "1" }
  ]
}
```
