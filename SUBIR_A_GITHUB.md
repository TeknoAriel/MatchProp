...
> **Repositorio oficial:** https://github.com/kiteprop/ia-matchprop  
> Producción y Vercel: **docs/SIGUIENTE_PASO.md** · **docs/REPO_OFICIAL_KITEPROP.md**
...
2. Instalá y abrí la app. Iniciá sesión con una cuenta que tenga acceso al org **kiteprop**.
...
7. Listo: el código queda en https://github.com/kiteprop/ia-matchprop
...
6. Pegá y ejecutá este comando (reemplazá `TU_TOKEN` por el token que copiaste):
   ```bash
   cd /Users/arielcarnevali/MatchProp && git push https://TU_USUARIO_GITHUB:TU_TOKEN@github.com/kiteprop/ia-matchprop.git main
   ```
...
3. Clic ahí. Si te pide, elegí "GitHub" e iniciá sesión con tu usuario con acceso a **kiteprop/ia-matchprop**.
