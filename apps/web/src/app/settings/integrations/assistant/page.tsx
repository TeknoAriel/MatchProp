    ...
    <main className="p-4">
      <div className="max-w-2xl mx-auto">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-xl font-bold text-[var(--mp-foreground)]">Asistente IA</h1>
          <Link
            href="/me/settings"
        ...
        <p className="text-sm text-[var(--mp-muted)] mb-4">
          Configurá usuario, contraseña, API key y token según el proveedor (OpenAI, Anthropic,
          Azure, custom). Para búsqueda y conversacional.
        </p>
        ...
        <div className="mt-6 p-4 rounded-xl bg-[var(--mp-bg)] border border-[var(--mp-border)]">
          <p className="text-xs text-[var(--mp-muted)]">
            Usá API Key para OpenAI/Anthropic. Token para proveedores que usen otro header. Usuario
            y contraseña para APIs con Basic Auth (custom).
          </p>
        </div>
      </div>
    </main>
